...
import com.hdl.hricheditor.utils.ItemTouchHelperAdapter;
import com.hdl.hricheditor.view.TXTEditorActivity;
...
public class RichEditorAdapter extends RecyclerView.Adapter<RichEditorAdapter.MyViewHolder> implements ItemTouchHelperAdapter {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        //设置内容
        holder.tvDesc.setText(TextUtils.isEmpty(eContent.getContent()) ? "点击添加文字内容" : eContent.getContent());
        /**
         * 根据类型显示item的图片
         */
